...
from .models import build_model, build_lstm_model
...
def compare_models(csv_path: str = "data/sample_reviews.csv"):
    ...
    results.append({"model": "Logistic Regression", "accuracy": accuracy_score(y_test, preds)})
    ...
    results.append({"model": "LSTM", "accuracy": accuracy_score(y_test_bin, lstm_preds)})
